## rc_genicam_api (noetic) - 2.6.5-1

The packages in the `rc_genicam_api` repository were released into the `noetic` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro noetic` on `Tue, 12 Mar 2024 14:50:09 -0000`
...
## rc_genicam_api (noetic) - 2.6.1-1

The packages in the `rc_genicam_api` repository were released into the `noetic` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro noetic` on `Fri, 10 Mar 2023 18:30:39 -0000`
...
## rc_genicam_api (melodic) - 2.6.1-1

The packages in the `rc_genicam_api` repository were released into the `melodic` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro melodic` on `Fri, 10 Mar 2023 18:20:05 -0000`
...
## rc_genicam_api (noetic) - 2.5.12-1

The packages in the `rc_genicam_api` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rc_genicam_api` on `Tue, 16 Nov 2021 11:21:07 -0000`
...
## rc_genicam_api (melodic) - 2.5.12-1

The packages in the `rc_genicam_api` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic rc_genicam_api` on `Tue, 16 Nov 2021 11:15:06 -0000`
...
## rc_genicam_api (rolling) - 2.5.6-1

The packages in the `rc_genicam_api` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling rc_genicam_api` on `Tue, 03 Aug 2021 09:13:32 -0000`
...
## rc_genicam_api (foxy) - 2.5.6-1

The packages in the `rc_genicam_api` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --ros-distro foxy rc_genicam_api` on `Tue, 03 Aug 2021 09:03:16 -0000`
...
## rc_genicam_api (noetic) - 2.5.6-1

The packages in the `rc_genicam_api` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rc_genicam_api` on `Tue, 03 Aug 2021 08:56:24 -0000`
...
## rc_genicam_api (melodic) - 2.5.6-1

The packages in the `rc_genicam_api` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic rc_genicam_api` on `Tue, 03 Aug 2021 08:12:52 -0000`
